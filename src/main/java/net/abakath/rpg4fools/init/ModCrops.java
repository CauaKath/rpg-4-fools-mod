...
public final class ModCrops {
  ...
  public static final CropDefinition SPINACH = new CropDefinition(
          "spinach", CropDefinition.Kind.FARMLAND, seasons(Season.SPRING, Season.AUTUMN), 1, 0.3f, false, 5, Support.NONE, false);
